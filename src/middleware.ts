...
export function middleware(request: NextRequest) {
  ...
  const publicPaths = ["/", "/login", "/registar", "/api/auth", "/recuperar-password", "/alterar-password", "/convite", "/sobre", "/contacto", "/termos", "/privacidade", "/api/stripe/webhook", "/api/stripe/debug-prices", "/api/debug", "/api/deploy", "/api/v1", "/api/tournament", "/mix", "/tv"];
